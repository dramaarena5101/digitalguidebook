    ...
    <div style={{ position: "relative", marginTop: "4rem", marginBottom: "4rem" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", position: "relative", zIndex: 1 }}>
        ...
        <motion.div 
          ...
          style={{ width: 240, height: 240, borderRadius: 32, background: "#FFF0E6", border: "2px solid #FDDCBF", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", zIndex: 10, boxShadow: "0 24px 48px rgba(255,107,0,0.15)", marginBottom: "3rem" }}
        >
          <img src="/logo.png" alt="Logo DA 5101" style={{ width: "80%", height: "80%", objectFit: "contain", filter: "drop-shadow(0 8px 16px rgba(0,0,0,0.1))" }} onError={e => e.target.style.display = 'none'} />
